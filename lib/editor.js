...
;(function(run) {
  ...
  // TH: /^import/ has been removed.
  // (map (comp name first) (seq clojure.lang.Compiler/specials))
  exports.specialForms = [
    "case", "try",
    "let", "let*", "letrec", "letrec*", "set!",
    "quote", "catch", "throw",

    "define", "define-public", "define-class", "define-method", /^([^\/]+\/)?def/,
    "if", "when", "unless", "while", "for",
    "cond", "apply",
...
//   }
  ...
  function isSpecialForm(spec, parentSexp, src) {
